<template>
  <div 
    :class="[
      'border-b border-gray-200 dark:border-gray-700 last:border-b-0 p-4 flex items-start',
  ...
  >
    ...
    <input 
      ...
      class="h-5 w-5 mt-1 rounded border-gray-300 text-blue-500 focus:ring-blue-500"
    />
    ...
    <div class="ml-3 flex-grow">
      ...
      <div class="mt-1">
        ...
        <div 
          :class="[
            'text-xs flex items-center flex-wrap', 
    ...
    <div class="flex space-x-1 ml-2">
      <button @click="$emit('toggle-priority', task)" 
              :class="[
                'text-gray-500 hover:text-yellow-500 dark:text-gray-400 dark:hover:text-yellow-400 p-1',
      ...
      <button @click="$emit('edit', task)" class="text-gray-500 hover:text-blue-500 dark:text-gray-400 dark:hover:text-blue-400 p-1">
        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
        </svg>
      </button>
      <button @click="$emit('delete', task.id)" class="text-gray-500 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400 p-1">
        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
